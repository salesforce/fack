...
ActiveRecord::Schema[7.2].define(version: 2026_03_14_000000) do
  ...
  create_table "documents", force: :cascade do |t|
    ...
    t.index ["deleted_date", "updated_at"], name: "index_documents_on_deleted_date_and_updated_at"
  ...
  create_table "libraries", force: :cascade do |t|
    ...
    t.string "source_url"
    t.text "description"
    t.virtual "search_vector", type: :tsvector, as: "to_tsvector('english'::regconfig, (((COALESCE(name, ''::character varying))::text || ' '::text) || COALESCE(description, ''::text)))", stored: true
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.index ["search_vector"], name: "index_questions_on_search_vector", using: :gin
